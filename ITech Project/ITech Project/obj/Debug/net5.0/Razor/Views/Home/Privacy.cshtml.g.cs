#pragma checksum "F:\00-FinalProjects MVC\cmder\teck\I-TECH-Project\ITech Project\ITech Project\Views\Home\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0162715d9f8980875d0feb0ff35e2787e32a813e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0162715d9f8980875d0feb0ff35e2787e32a813e", @"/Views/Home/Privacy.cshtml")]
...
<section class=""page-section g"">
    ...
    <p>This Privacy Policy will inform you about the types of personal data we collect, the purposes for which we use the data, the ways in which ");
            WriteLiteral(@"the data is handled and your rights with regard to your personal data. Furthermore, this Privacy Policy is intended to satisfy the obligation of transparency under the EU General Data Protection Regulation 2016/679 (""GDPR"") and the laws implementing GDPR.</p>
    ...
    <p>For purposes of this Privacy Policy, ""Your Information"" or ""Personal Data"" means information about you, which may be of a confidential or sensitive nature and may include personally identifiable information (""PII"") and/or financial information. PII means individually identifiable information that would allow us to determine the actual");
            WriteLiteral(@" identity of a specific living person, while sensitive data may include information, comments, content and other information that you voluntarily provide.</p>
    ...
    <ol>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""information-collected-through-your-use-of-our-services"">Information Collected Through Your Use of Our Services</h2>
        <p>The following are situations in which you may provide Your Information");
            WriteLiteral(@" to us:</p>
        <ol>
            <li>
            ...
            <li>
            <p>When you communicate with us or request informa");
            WriteLiteral(@"tion about us or our products or Services, whether via email or other means; and</p>
            </li>
            <li>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""information-collected-from-other-sources"">Information Collected From Other Sources</h2>
        <p>We may also receive information from other sources and combine that with information we collect through our Services");
            WriteLiteral(@". For example if you choose to link, create, or log in to your Lorem Ipsum account with a social media service, e.g. LinkedIn, Facebook or Twitter, or if you engage with a separate App or Website that uses our API, or whose API we use, we may receive information about you or your connections from that Site or App. This includes, without limitation, profile information, profile picture, gender, user name, user ID associated with your social media account, age range, language, country, friends list, and any other information you permit the social network to share with third parties. The data we receive is solely dependent upon your privacy settings with the social network.</p>
        </li>
        <li>
        <h2 class=""f5 cl-orange"" id=""information-third-parties-provide"">Information Third Parties Provide</h2>
        <p>We may collect information about you from sources other than you, such as from social media websites (i.e., Facebook, LinkedIn, Twitter or others), blogs, analytics providers, business af");
            WriteLiteral(@"filiates and partners and other users. This includes, without limitation, identity data, contact data, marketing and communications data, behavioral data, technical data and content data.</p>
        </li>
        <li>
        ...
        <ol>
            ...
            <li>
            <p>We use Cookies to help us know that you are logged on, provide you with features based on your preferences, understand when you are interacti");
            WriteLiteral(@"ng with our Services, and compile other information regarding use of our Services.</p>
            </li>
            <li>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""protective-measures-we-use"">Protective Measures We Use</h2>
        <p>We protect your information using commercially reasonable technical and administrative security measures to reduce the risks of loss, misuse, unauthorized access, disclosure and alteration. Although we take measures to secure your information, we do not promise, and you should not expect, that your personal information, or searches, or other information will always remain secure. We cannot guarantee the security of our information storage, nor can we guarantee that the information you supply will not be intercepted while being trans");
            WriteLiteral(@"mitted to and from us over the Internet including, without limitation, email and text transmissions. In the event that any information under our control is compromised as a result of a breach of security, we will take reasonable steps to investigate the situation and where appropriate, notify those individuals whose information may have been compromised and take other steps, in accordance with any applicable laws and regulations.</p>
        </li>
        <li>
        <h2 class=""f5 cl-orange"" id=""the-legal-basis-for-collection-and-processing-of-your-personal-information"">The Legal Basis For Collection and Processing of Your Personal Information</h2>
        ...
        <ol>
            <li>
            <p>When signing up subscribing to use our Services, you have given us explicit consent allowing Lorem Ipsum to provide you with our Services and generally to process your");
            WriteLiteral(@" information in accordance with this Privacy Policy; and to the transfer of your personal data to other jurisdictions including, without limitation, the United States;</p>
            </li>
            <li>
            ...
            <li>
            <p>To send communications via");
            WriteLiteral(@" email and within the Services, including, for example, responding to your comments, questions and requests, providing customer support, and sending you technical notices, product updates, security alerts, and administrative and account management related messages.</p>
            </li>
            <li>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""h");
            WriteLiteral(@"ow-we-use-information-we-collect"">How We Use Information We Collect</h2>
        ...
        <ol>
            ...
            <ol>
                ...
                <li>
                <p>Resolve problems and disputes, and engage in other legal and security matte");
            WriteLiteral(@"rs.</p>
                </li>
                <li>
       ...
       ");
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""how-we-share-information-we-collect"">How We Share Information We Collect</h2>
        <ol>
            <li>
  ...
  ");
       ...
       ");
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""sharing-information-with-law-enforcement"">Sharing Information With Law Enforcement</h2>
        <ol>
            <li>
            ...
            <li>
 ");
            WriteLiteral(@"           <p>Furthermore, under 18 U.S.C. §§ 2702(b)(8) and 2702(c)(4) (Voluntary Disclosure Of Customer Communications or Records), Lorem Ipsum may disclose user account information to law enforcement,  without a subpoena, court order, or search warrant, in response to a valid emergency when we believe that doing so is necessary to prevent death or serious physical harm to someone. Lorem Ipsum will not release more information than it prudently believes is necessary to prevent harm in an emergency situation.</p>
            </li>
        </ol>
        </li>
        <li>
        <h2 class=""f5 cl-orange"" id=""social-media-sharing"">Social Media Sharing</h2>
        <p></p>
        <ol>
            <li>
            ...
            WriteLiteral(@"public, depending on the settings you establish with the social sharing service. Please refer to the privacy policies of those social sharing services for more information about how they handle the data you provide to or share through them.</p>
            </li>
            <li>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""analytic-services-provided-by-o");
            WriteLiteral(@"thers"">Analytic Services Provided By Others</h2>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""links-to-third-party-websites"">Links to Third-Party Websites</h2>
        <ol>
            <li>
            <p>Our Services, as well as the email messages sent with respect to our Services, may contain links or access to websites operated by third parties that are beyond our control. Links or access to third parties from our Services are not an endorsement by us of such third parties, or their websites, applications, products, services, or prac");
            WriteLiteral(@"tices. We are not responsible for the privacy policy, terms and conditions, practices or the content of such third parties. These third-parties may send their own Cookies to you and independently collect data.</p>
            </li>
            <li>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""do-not-track-settings"">Do Not Track Settings</h2>
        <p>Some web browsers may give you the ability to enable a ""do not track"" feature that sends signals to the websites you visit, indicating that you do not want your online");
            WriteLiteral(@" activities tracked. We do not respond to ""do not track"" signals at this time; if we do so in the future, we will describe how in this Privacy Policy.</p>
        </li>
        <li>
        <h2 class=""f5 cl-orange"" id=""international-privacy-policies"">International Privacy Policies</h2>
        <p>In order to provide our products and services to you, we may send and store your personal information outside of the country where you reside or are located, including to the United States. Accordingly, if you reside or are located outside of the United States, your personal information may be transferred outside of the country where you reside or are located, including countries that may not, or do not, provide the same level of protection for your personal information. We are committed to protecting the privacy and confidentiality of personal information when it is transferred. If you reside or are located within the European Economic Area and such transfers occur, we take appropriate steps to provide the same ");
            WriteLiteral(@"level of protection for the processing carried out in any such countries as you would have within the European Economic Area to the extent feasible under applicable law. By using and accessing our products and services, users who reside or are located in countries outside of the United States agree and consent to the transfer to and processing of personal information on servers located outside of the country where they reside, and assume the risk that the protection of such information may be different and may be less protective than those required under the laws of their residence or location.</p>
        </li>
        <li>
        <h2 class=""f5 cl-orange"" id=""account-information"">Account Information</h2>
        <p>You may correct your account information at any time by logging into your online account. If you wish to cancel your account, please email us at <a href=""mailto:legal@wasai.co"">legal@wasai.co</a> Please note that in some cases we may retain certain information about you as required by law, or");
            WriteLiteral(@" for legitimate business purposes to the extent permitted by law.</p>
        </li>
        <li>
        <h2 class=""f5 cl-orange"" id=""promotional-information-opt-out"">Promotional Information Opt Out</h2>
        ...
        <li>
        <h2 class=""f5 cl-orange"" id=""your-access-and-rights-to-your-personal-information"">Your Access and Rights to Your Personal Information</h2>
        <p>You have certain rights in relation to Personal Information we hold about you. You can exercise any of the following rights by contacting us using a");
            WriteLiteral(@"ny of the methods in the Contact section below. We may need to request specific information from you to help us confirm your identity and ensure your right to access your Personal Data (or to exercise any of your other rights). This is a security measure to ensure that Personal Data is not disclosed to any person who has no right to receive it. We try to respond to all legitimate requests within one month. Occasionally it may take us longer than a month if your request is particularly complex or you have made a number of requests. In this case, we will notify you and keep you updated.</p>
        <ol>
            <li>
            <p><strong>Right to Access Your Personal Data.</strong> You have the right to access information held about you for the purpose of viewing and in certain cases updating or deleting such information. Furthermore, if you prefer that Lorem Ipsum does not share certain information as described in this Privacy Policy, you can direct Lorem Ipsum not to share that information. We will co");
            WriteLiteral(@"mply with an individual’s requests regarding access, correction, sharing and/or deletion of the personal data we store in accordance with applicable law. To make changes to your account affecting your personal information contact us at the email address in our Contact section below. For any deletion, non-sharing or update request, we will make the changes as soon as practicable, however this information may stay in our backup files. If we cannot make the changes you want, we will let you know and explain why.</p>
            </li>
            <li>
            ...
            WriteLiteral(@"ve challenged the accuracy of the information and during the period where we are verifying its accuracy. To object to or restrict processing please contact us at the email address in our Contact section below.</p>
            </li>
            <li>
        ...
        <ol>
            ...
            <li>
            <p>If you are a California resident and would like to make such a request, please submit your request in wr");
            WriteLiteral(@"iting to: <a href=""mailto:legal@wasai.co"">legal@wasai.co</a></p>
            </li>
        </ol>
        </li>
        <li>
        ...
        <p>If you have any questions or if you would like to contact us about our processing of your personal information, including exercising your rights as outlined above, please contact us by any ");
            WriteLiteral("of the methods below. When you contact us, we will ask you to verify your identity.</p>\r\n        </li>\r\n    </ol>\r\n    </div>\r\n</section>\r\n</div>");
        }
